iteration=300
scenario='multi_04'
log_file="result_${scenario}_random.log"
result_file="result_${scenario}_random.txt"
csv_file="result_${scenario}_random"
sampler_idx=0 # 0 / 1 / 2 / -1 (-1 is for alternate)
sampler_type=random # demab / dmab / random / dce / halton / udemab
