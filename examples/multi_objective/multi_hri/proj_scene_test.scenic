...
EGO_SPAWN_X = Range(-0.5, 0.5)
FETCH_SPAWN_Y = Range(-2.5, -5.0)

ego = new Female_0 at (EGO_SPAWN_X, -4.8, 0), with yaw -90 deg,
                                with behavior ReachHandAndWalk((EGO_DEST_X, -3.0, 0), (-0.5, -0.5, 0.5))
...
fetch = new FetchRobot at (-3.7, FETCH_SPAWN_Y, 0), with yaw 90 deg, with behavior Traverse()
