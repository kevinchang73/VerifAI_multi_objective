...
for i in range(len(lines)):
    if mode == 'multi':
        if 'RHO' in lines[i]:
            ...
            result_count_0[curr_source].append(val1[1]*1 + val1[3]*2)
            if tuple(1*np.array([val1[1], val1[3]])) in counterexample_type_0[curr_source]:
                counterexample_type_0[curr_source][tuple(1*np.array([val1[1], val1[3]]))] += 1
            else:
                counterexample_type_0[curr_source][tuple(1*np.array([val1[1], val1[3]]))] = 1
            ...
            result_count_1[curr_source].append(val2[0]*2 + val2[2]*1)
            if tuple(1*np.array([val2[0], val2[2]])) in counterexample_type_1[curr_source]:
                counterexample_type_1[curr_source][tuple(1*np.array([val2[0], val2[2]]))] += 1
            else:
                counterexample_type_1[curr_source][tuple(1*np.array([val2[0], val2[2]]))] = 1
