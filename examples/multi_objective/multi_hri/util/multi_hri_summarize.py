...
file_names = ['result_multi_hri_demab0.txt', 'result_multi_hri_dmab0.txt',  'result_multi_hri_halton.txt']
...
file_names = ['result_multi_hri_demab1.txt', 'result_multi_hri_dmab1.txt', 'result_multi_hri_halton.txt']
for file in file_names:
    f = open(dir_name + file, 'r')
    lines = f.readlines()
    f.close()
