iteration=300
scenario='multi_04'
log_file="result_${scenario}_udemab.log"
result_file="result_${scenario}_udemab.txt"
csv_file="result_${scenario}_udemab"
sampler_idx=0 # 0 / 1 / 2 / -1 (-1 is for alternate)
sampler_type=udemab # demab / dmab / random / dce / halton / udemab
